      ...
      <form className="" onSubmit={handleSubmit}>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input id="subject" type="text" name="form[subject]" value={form.subject || ""} onChange={(e) => setForm({ ...form, subject: e.target.value })} />
          </div>
        </div>
        <div>
          <label htmlFor="message">Messsage</label>
          <textarea id="message" name="form[message]" value={form.message || ""} onChange={(e) => setForm({ ...form, message: e.target.value })} />
        </div>
